...
if ( 'speechSynthesis' in window )
{
	...
	//$speed.addEventListener( 'blur', adjustSpeed, false );
	//$speed.addEventListener( 'keyup', adjustSpeed, false );
	//$speed.addEventListener( 'click', adjustSpeed, false );
	//$speed.addEventListener( 'touchend', adjustSpeed, false );
